 ...
 * @param {Object} [schema={}] - Schema defining recognized flags.
 * 
 * @returns {Object} An object mapping flag names to boolean values indicating presence.
 */
export function parseFlags(argv, schema = {}) {
  const flags = {};

  for (const [key, flag] of Object.entries(schema)) {
    flags[key] = argv.includes(flag);
  }
